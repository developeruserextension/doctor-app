...
// tslint:disable-next-line: max-line-length
      description_card:'“My new practice took off in no time, thanks to the advice I received from Zocdoc!”'
    },
    { image: 'assets/images/join_images/card-image.png',
      doctor_name:'Dr. Charles Pearson, DDS',
      provider_bio: 'Dentist Sterling Heights, MI',
// tslint:disable-next-line: max-line-length
      description_card:'“Zocdoc has greatly assisted in new patients for our office. I would say over 50 percent have had return visits and have referred others.”'
    },
    {
      image: 'assets/images/join_images/card-image.png',
...
// tslint:disable-next-line: max-line-length
      description_card:'“Zocdoc has been excellent. I especially like the fact that you help to get the insurance information at the time of booking.”'
    },
    {
      image: 'assets/images/join_images/card-image.png',
